...
import com.simplilearn.SportyShoes.model.Customer;
import com.simplilearn.SportyShoes.model.Purchase;
import com.simplilearn.SportyShoes.service.CartService;
import com.simplilearn.SportyShoes.service.CustomerService;
...
public class CustomerController {
	...
	public String verifyLogin(@RequestParam(name = "email") String email,
		...
		if (!email.isEmpty() || !password.isEmpty()) {
			if (customerService.loginVerify(email, password)) {
				...
				model.addAttribute("action", "wrong email or password");
	...
	public String customerOrders(@PathVariable(name = "email") String email, Model model,HttpSession session) {
		...
		return "customerPurchase";
			...
			session.setAttribute("action", "No Active Orders by Customer");
			return "redirect:/manageCustomer";
		}
	}
